...
/*
|----------------------------------------------------------------------
| Country name -> ISO-3166 alpha-2 map (lower-cased names)
|----------------------------------------------------------------------
| ShopifyQL's billing_country returns country NAMES ('Spain'), but Meta's
| country breakdown and config/country_regions.php both key on ISO-2 codes
| ('ES'). CountryCodes::toIso2() uses this to normalise Shopify country
| names to codes so commerce revenue joins Meta spend and folds into
| regions. Generated from pycountry (ISO 3166-1) + common Shopify variants.
*/
