...
const DASHBOARD_ROWS: DashboardRow[] = [
  {
    brand: BRANDS[0],
    yesterday: { revenue: 8420, revenueNet: 8420, netSales: 8420, refundsAmount: 0, metaSpend: 1520, googleSpend: 680, tiktokSpend: 330, totalSpend: 2530, roas: 3.33, isComplete: true },
    dayBefore: { revenue: 7489, revenueNet: 7489, netSales: 7489, refundsAmount: 0, metaSpend: 1460, googleSpend: 680, tiktokSpend: 278, totalSpend: 2418, roas: 3.10 },
    last7d:    { revenue: 52860, revenueGross: 52860, netSales: 52860, revenuePrior7d: 47012, revenueGrossPrior7d: 47012, netSalesPrior7d: 47012, isComplete: true },
  },
  {
    brand: BRANDS[1],
    yesterday: { revenue: 5210, revenueNet: 5210, netSales: 5210, refundsAmount: 0, metaSpend: 890, googleSpend: 380, tiktokSpend: 140, totalSpend: 1410, roas: 3.70, isComplete: true },
    dayBefore: { revenue: 5376, revenueNet: 5376, netSales: 5376, refundsAmount: 0, metaSpend: 901, googleSpend: 383, tiktokSpend: 140, totalSpend: 1424, roas: 3.78 },
    last7d:    { revenue: 36040, revenueGross: 36040, netSales: 36040, revenuePrior7d: 37196, revenueGrossPrior7d: 37196, netSalesPrior7d: 37196, isComplete: true },
  },
  {
    brand: BRANDS[2],
    yesterday: { revenue: null, revenueNet: null, netSales: null, refundsAmount: null, metaSpend: 890, googleSpend: 410, tiktokSpend: null, totalSpend: 1300, roas: null, isComplete: false },
    dayBefore: { revenue: null, revenueNet: null, netSales: null, refundsAmount: null, metaSpend: 842, googleSpend: 398, tiktokSpend: null, totalSpend: 1240, roas: null },
    last7d:    { revenue: null, revenueGross: null, netSales: null, revenuePrior7d: null, revenueGrossPrior7d: null, netSalesPrior7d: null, isComplete: false },
  },
  {
    brand: BRANDS[3],
    yesterday: { revenue: 4050, revenueNet: 4050, netSales: 4050, refundsAmount: 0, metaSpend: 770, googleSpend: 280, tiktokSpend: 360, totalSpend: 1410, roas: 2.87, isComplete: true },
    dayBefore: { revenue: 3794, revenueNet: 3794, netSales: 3794, refundsAmount: 0, metaSpend: 691, googleSpend: 280, tiktokSpend: 295, totalSpend: 1266, roas: 3.00 },
    last7d:    { revenue: 28400, revenueGross: 28400, netSales: 28400, revenuePrior7d: 26592, revenueGrossPrior7d: 26592, netSalesPrior7d: 26592, isComplete: true },
  },
  {
    brand: BRANDS[4],
    yesterday: { revenue: 2810, revenueNet: 2810, netSales: 2810, refundsAmount: 0, metaSpend: 590, googleSpend: 210, tiktokSpend: null, totalSpend: 800, roas: 3.51, isComplete: true },
    dayBefore: { revenue: 2850, revenueNet: 2850, netSales: 2850, refundsAmount: 0, metaSpend: 603, googleSpend: 211, tiktokSpend: null, totalSpend: 814, roas: 3.50 },
    last7d:    { revenue: 19720, revenueGross: 19720, netSales: 19720, revenuePrior7d: 19996, revenueGrossPrior7d: 19996, netSalesPrior7d: 19996, isComplete: true },
  },
  {
    brand: BRANDS[5],
    yesterday: { revenue: 2030, revenueNet: 2030, netSales: 2030, refundsAmount: 0, metaSpend: 410, googleSpend: 160, tiktokSpend: null, totalSpend: 570, roas: 3.56, isComplete: true },
    dayBefore: { revenue: 1948, revenueNet: 1948, netSales: 1948, refundsAmount: 0, metaSpend: 402, googleSpend: 159, tiktokSpend: null, totalSpend: 562, roas: 3.47 },
    last7d:    { revenue: 14210, revenueGross: 14210, netSales: 14210, revenuePrior7d: 13637, revenueGrossPrior7d: 13637, netSalesPrior7d: 13637, isComplete: true },
  },
];
...
export async function getTickets(): Promise<Ticket[]> {
  ...
  return [
    ...
    { id: 1145, brand: { id: 3, name: 'Nova Threads' }, raisedBy: { id: 1, name: 'Helm system' }, assignedTo: { id: 1, name: 'Kanwar' }, title: 'Nova Threads Shopify connection keeps failing', category: 'bug', status: 'in_progress', priority: 'urgent', externalTaskUrl: null, createdAt: '2026-05-15T13:30:00Z' },
