...
/**
 * Store audit hub — a top-level page (like Inventory / Ads / Products) that lands
 * on a brand chooser and, once a brand is picked, shows its rules-driven store
 * audit inline. Master admin / manager get the brand-manager (team) filter to
 * scope the list; everyone else sees their brands.
 */
export function StoreAuditPage() {
  ...
  return (
    <AppLayout title="Store audit">
      ...
      <BrandAuditView slug={selectedSlug} />
    </AppLayout>
  );
}
...
/** Inline searchable brand switcher for the filter bar (mirrors Inventory / Ads / Products). */
  ...
  return (
    <div style={{ maxWidth: 560, margin: '7vh auto 0' }}>
      ...
      <p className="lede" style={{ textAlign: 'center', margin: '0 auto 18px', maxWidth: 440 }}>
        Open a store to see its rules-driven audit — waste, breakeven, refunds, tracking gaps and stock risks.
      </p>
